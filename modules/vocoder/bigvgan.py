...
class BigVGAN(
    ...
    def inference(self, mel: torch.Tensor) -> torch.Tensor:
        """
        Inference method for BigVGAN vocoder. Takes a Mel spectrogram as input and generates the corresponding audio waveform.

        Args:
            mel (torch.Tensor): Input Mel spectrogram of shape (N, n_mel_bins, T_mel).
        
        Returns:
            torch.Tensor: Generated audio waveform of shape (N, 1, T_audio) in the range [-1, 1].
        """
